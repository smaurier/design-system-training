// Button.tsx — CONSOMMATEUR EXISTANT, DONNÉ. Ne se modifie pas dans ce lab — seul
// `tokens.css` change. Les tokens sont chargés séparément (voir test/dark-mode.test.tsx).
